//
//  PreviousTournamentCollectionViewCell.swift
...
class PreviousTournamentCollectionViewCell: UICollectionViewCell {
    ...
    let swissTournamentIcon: UIImageView = {
        let iv = UIImageView()
        iv.backgroundColor = UIColor.CHESSGREEN()
    ...
    let titleLabel: UILabel = {
        ...
        label.text = "Wednesday, Feburary 20th"
    ...
    func setupViews() {
        ...
        swissTournamentIcon.anchor(top: containerView.topAnchor, left: nil, bottom: containerView.bottomAnchor, right: containerView.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 144, height: 38)
        
        containerView.addSubview(titleLabel)
        titleLabel.anchor(top: containerView.topAnchor, left: containerView.leftAnchor, bottom: nil, right: swissTournamentIcon.leftAnchor, paddingTop: 20, paddingLeft: 20, paddingBottom: 0, paddingRight: 0, width: 0, height: 39)
        
        containerView.addSubview(descriptionLabel)
        descriptionLabel.anchor(top: titleLabel.bottomAnchor, left: containerView.leftAnchor, bottom: containerView.bottomAnchor, right: swissTournamentIcon.leftAnchor, paddingTop: 10, paddingLeft: 20, paddingBottom: -15, paddingRight: 13, width: 0, height: 0)
