//
//  SelectSitOutPlayerViewController.swift
...
class SelectSitOutPlayerViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    
    var addPlayersViewController = AddPlayersViewController()
    
    var sitOutCellId = "SitOutCellId"
    var names: [String] = []
    var players: [Player] = []
    ...
    func setupUI() {
        ...
        navigationController?.navigationBar.topItem?.title = "Select Sit Out Player"
        navigationItem.title = "Select Sit Out Player"
        view.backgroundColor = UIColor.GRAY()
        
        view.addSubview(descriptionLabel)
        descriptionLabel.anchor(top: margins.topAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 40, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 20)
    ...
    func registerCells(){
        collectionView.register(PlayerCell.self, forCellWithReuseIdentifier: sitOutCellId)
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: sitOutCellId, for: indexPath) as! PlayerCell
